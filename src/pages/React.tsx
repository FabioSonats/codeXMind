        ...
        return (
            <div style={pageStyle}>
                <div style={containerStyle}>
                    <div style={loadingStyle}>Carregando artigos de React...</div>
                </div>
            </div>
        );
    }
            ...
            <div style={containerStyle}>
                ...
                <div style={headerStyle}>
                    ...
                    <div style={categoryHeaderStyle}>
                        ...
                        <h1 style={categoryTitleStyle}>React</h1>
                    </div>

                    <p style={categoryDescriptionStyle}>
                        React, Hooks, Context e ecossistema. Aprenda a construir interfaces modernas e reativas.
                    </p>
