...
export default function Library() {
    ...
    const [items, setItems] = useState<Array<{id: string; title: string; type: string; description: string; downloadUrl: string; previewUrl?: string; tags: string[]; language: string; level: string; size: string; format: string}>>([]);
                        ...
                        <div key={item.id} style={cardStyle}>
                            ...
                            <div style={metaStyle}>
                                <span style={{ color: getLevelColor(item.level) }}>
                                    {item.level === 'beginner' ? '🟢 Iniciante' :
                                        item.level === 'intermediate' ? '🟡 Intermediário' :
                                            '🔴 Avançado'}
                                </span>
