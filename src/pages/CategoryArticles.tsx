 ...
 * Displays all articles from a specific category in a list format
 */
export default function CategoryArticles() {
    ...
    return (
      <div style={pageStyle}>
        <div style={containerStyle}>
          <div style={loadingStyle}>Carregando artigos da categoria...</div>
        </div>
      </div>
    );
  }
  ...
  if (!category) {
    return (
      <div style={pageStyle}>
        <div style={containerStyle}>
          <div style={errorStyle}>Categoria não encontrada</div>
        </div>
      </div>
    );
  }
      ...
      <div style={containerStyle}>
        ...
        <div style={headerStyle}>
          ...
          <div style={categoryHeaderStyle}>
            ...
            <h1 style={categoryTitleStyle}>{category.name}</h1>
          </div>
